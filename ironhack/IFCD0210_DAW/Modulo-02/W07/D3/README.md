...
- Access and modify _content of HTML elements_ using HTML element properties

  > `element.textContent`, `element.innerHTML`

- Add or remove _HTML elements_ to the DOM using Javascript DOM methods

  > `document.createElement()`, `element.append()` , `element.appendChild()`, `element.removeChild()`

- Add or remove _event listeners_ to respond to user actions, such as button clicks

  > `element.addEventListener()`, `element.removeEventListener()`

- Pass functions as arguments to other functions (callbacks)

- Iterate over _lists of HTML elements_ and perform actions on each, such as accessing values, adding or removing events, etc.
